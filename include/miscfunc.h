...
//  static int myClampBetween(int val, const int valmax, const int valmin);
//  static double myClampBetween(double val, const double valmax, const double valmin);
...
//  static osg::Quat convert(const glm::dquat);
