...
CFEFunctorMatrixGradUauxK1::CFEFunctorMatrixGradUauxK1( CCrackInInterface *c1, CFEFunctorVectorLagrangeX *x ):CFEFunctorMatrix("CFEFunctorMatrixUauxK1"),crack(c1),X( x )
{
	AddNode( X );
}

CFEFunctorMatrixGradUauxK1::CFEFunctorMatrixGradUauxK1( const CFEFunctorMatrixGradUauxK1 &vf ):CFEFunctorMatrix(vf),crack(vf.crack)
{
	CLONE_MEMBER( vf, X )
}

CFEFunctorMatrixGradUauxK1::~CFEFunctorMatrixGradUauxK1( void )
{

}

void CFEFunctorMatrixGradUauxK1::Compute( CFiniteElementInstance *fe1 )
{
